...
my ($shortmath, $shortarray, $indent,   $parsep,     $state,     $descend,
    $ascend,    $previous,   $preamble, $dopreamble, $curindent, $man,
    $help,      $gpl,        $version,  $verstring
);

$verstring
    = "fmtlatex version 1.1, Copyright (C) 2007--2013 Andrew Stacey\nfmtlatex comes with ABSOLUTELY NO WARRANTY; for details type\n `fmtlatex --man'.\nThis is free software, and you are welcome to redistribute it under certain\nconditions; type `fmtlatex --man' for details.";
